...
const Navbar = ({ businessData, userData }) => {
      ...
      <AppLayout>
        <ul className="text-center text-xl px-[20px] shadow-2xl  transition-transform duration-200 transform ">
          <li className="my-4 py-4 border-black ">
            <Link to={"/business/" + userData?.bd_business_id}>Home</Link>
          </li>
          <li className="my-4 py-4 border-black">
        ...
        <nav>
          <div className="h-16 flex justify-between z-20 text-white lg:py-5 px-[20px] py-4 ">
            <div className="flex items-center flex-1">
              <a href={"/business/" + userData?.bd_business_id}>
                <span className="text-3xl font-bold" style={{ textTransform: "capitalize" }}>{businessData?.ub_business_name}</span>
              </a>
            </div>
