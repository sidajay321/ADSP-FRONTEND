    ...
    return (
        <div className='h-screen w-full bg-[#1f1c147c] fixed top-0 flex justify-center items-center'>
            ...
            <div className='flex w-full items-center'>
                ...
                <img alt='' src={imagarr[imsg]} className='w-full transition-transform transform duration-100 hover:scale-110 h-[380px] mx-auto md:h-[400px] md:w-[480px] lg:h-[400px] lg:w-[480px] lg:rounded-[1px]' />
